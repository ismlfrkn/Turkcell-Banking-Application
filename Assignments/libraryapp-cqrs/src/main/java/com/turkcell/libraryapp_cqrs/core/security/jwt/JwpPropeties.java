package com.turkcell.libraryapp_cqrs.core.security.jwt;
...
public class JwpPropeties {
    ...
    private String issuer = "libraryapp_cqrs"; //JWT token’ını hangi uygulamanın / servisin ürettiğini belirten bilgidir.
